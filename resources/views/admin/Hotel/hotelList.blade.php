      ...
      <tbody>
        ...
        <tr>
          ...
          <a href="{{ url('/admin/hotel/hotelView/')}}/{{$hld->id}}" class="btn btn-sm btn-clean btn-icon mr-2" title="View details">
		   ...
		   @if($hld->status=='ACTIVE')
           <a href="{{ url('/admin/hotel/hotel_status/')}}/{{$hld->id}}?status=INACTIVE" class="btn btn-sm btn-clean btn-icon mr-2" title="Inactive the hotel">
            <button class="btn btn-danger btn-sm"style=" margin-left: 38px;" >Inactive</button>
          </a>
            @endif
            @if($hld->status=='INACTIVE')
            <a href="{{ url('/admin/hotel/hotel_status/')}}/{{$hld->id}}?status=ACTIVE" class="btn btn-sm btn-clean btn-icon mr-2" title="Active the hotel details">
            <button class="btn btn-success btn-sm"style=" margin-left: 38px;" >Active</button>
          </a>
            @endif
