      ...
      <div class="d-flex mb-9">
        ...
        <div class="flex-shrink-0 mr-7 mt-lg-0 mt-3">
          <div class="symbol symbol-50 symbol-lg-120"> 
            ...
            <img src="{{ asset('uploads/hotels_featured_images/'.$hotelsData->featured_image) }}" alt="image" /> 
        ...
        <div class="flex-grow-1">
          ...
          <div class="d-flex justify-content-between flex-wrap mt-1">
           ...
           <div class="my-lg-0 my-3">
		      <a href="<?php echo asset("uploads/licence/$hotelsData->licence") ?>" target="_blank" class="btn btn-sm btn-info font-weight-bolder text-uppercase">License</a>
      ...
      <div class="col-sm-6 col-lg-3 mb-5" id="galleryDiv_{{$imgUp->id}}">
       <div class="card">
        ...
        <div class="image-input image-input-outline" id="kt_image_{{$i++}}" style="background-image: url(assets/media/users/blank.png)">
            ...
            <div class="image-input-wrapper card-img img-fluid" style="background-image: url({{  asset('uploads/hotels_gallery_images/'.$imgUp->image)}}); height: 130px; background-repeat: no-repeat; width: 100%;"></div>
