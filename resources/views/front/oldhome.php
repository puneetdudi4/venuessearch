		...
		<section class="booking-section" style="">
			...
			<div class="web_text" style="">
			          ...
			          Book Your     <span class="home-text" style="">Hotel Venue</span>
						...
						<span style="" class="home-title"> Your Budget, Your Event, Your Way.</span>
		...
		<!-- Book Form End -->
			...
			<div class="row">
			 ...
			 <div class="col-lg-12 col-md-12">
			  ...
			  <h3 class="color_darkgoldenrod text-center" style="margin-bottom:10px">Welcome To HotelsVenues </h3>
...
من مكان واحد و بأفضل الاسعار و استفيدوا من الخصومات الرائعه و التوفير على حسب ميزانيتكم و ذوقكم</a></p>
			...
			<div class="row">
			 ...
			 <div class="col-lg-12 col-md-12">
			  ...
			  <h3 class="color_darkgoldenrod text-center" style="margin-bottom:0px">Best Venues For Events </h3>
               <p style="width:100%; text-align:center; margin-bottom:10px">Explore event spaces at these outstanding venues this month </p>
			   ...
			   ?>
				...
				if(strlen($value->location	)>50)
				{
			     ...
			     ?>
								...
								<img data-src="{{ asset('uploads/hotels_featured_images/'.$value->featured_image)}}" alt="{{ $value->name }}"  style="height: 250px; width:100%" class="1hrotate_image lazyload"  >
									  <div class="hmiddle">
    ...
    font-size: 13px;" >Click for More Details </a>
			...
			?>
		       	   ...
		       	   <a class="button_image link buttonimage-fade btn_hoimecoursal" href="https://hotelsvenues.com/hotels" style=" font-weight: bold; color: #FFF ! important;background:#000; padding:10px  20px;">View More </a>
...
<!--MoDALK END-->
   ...
   font-family: "Playfair Display", Constantia, "Lucida Bright", Lucidabright, "Lucida Serif", Lucida, "DejaVu Serif", "Bitstream Vera Serif", "Liberation Serif", Georgia, serif;
    ...
    margin-bottom: 0px ! important;
                    ...
                    <h1 class="color_darkgoldenrod1">Venues By Event Type</h1>
                </div>
				
				<div class="row">
				
				 <p style="width:100%; text-align:center">Venues recognised for their outstanding performance in hosting particular event types</p>
				 ...
				 @foreach($supplierlist as $i=>$value)
                   ...
                   @endforeach
					...
					<div class="section-title text-center mb-4">
                        <a class="" href="{{ url('/supplierList') }}" style=" font-weight: bold; color: #FFF ! important;background:#000; padding:10px  20px; border-radius:10px;">View More </a>
                    </div>
    		       ...
    		       <div class="col-md-6 col-12">
                    ...
                    @csrf
                        <!--<form name="quotation" method="POST">-->
                            ...
                            type="text" id="full_name" placeholder="Full Name" name="fullname" value="" autocomplete="off" style="color:#3e3737;  background-color: #efecec9c ! important;">
                      ...
                      <select name="budget" id="budget">
                                ...
                                <div class="col-md-12 col-12">
                                    <div class="input-wrap">
                                        <input type="email" placeholder="Your Email"    name="email" autocomplete="off"  id="email" style="color:#3e3737;  background-color: #efecec9c ! important;">
                            <!--          <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg font-size-h6"-->
                            ...
                            <i class="far fa-envelope"></i>
                                ...
                                <div class="col-md-12 col-12">
                                    <div class="input-wrap">
                                        <input type="text" placeholder="Your Mobile" required  name="mobile"  id="website"  autocomplete="off" value="" onkeypress="return MobileNumber(event);" style="color:#3e3737;  background-color: #efecec9c ! important;">
                            <!--            <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg font-size-h6"-->
                            <!--type="number" id="mobile_no" placeholder="Mobile No" name="mobileno" autocomplete="off" value="" onkeypress="return MobileNumber(event);" style="color:#3e3737;  background-color: #efecec9c ! important;">-->
                             ...
                             <i class="fab fa-wordpress"></i>
                                ...
                                <div class="col-12 text-center">
                                    <button type="submit" class="btn filled-btn"><a href="https://hotelsvenues.com/hotels">Send</a>  <i
