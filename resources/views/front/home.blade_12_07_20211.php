						...
						<div class="row">
							...
							<div class="col-lg-2 col-md-6">
								<div class="input-wrap">
								  ...
								  $budgets=array('5000-10000'=>'5000-10000',
									...
									'70000-75000'=>'70000-75000',
									'75000-80000'=>'75000-80000',
									'80000-85000'=>'80000-85000',
									'80000-85000'=>'80000-85000',
									'85000-90000'=>'85000-90000',
									'95000-100000'=>'95000-100000'
				...
				<div class="row align-items-center no-gutters">
					...
					<div class="col-lg-4">
						<div class="tile-gallery">
							<img style="height:100%" src="{{asset('front_end/img/hotels.jpg')}}" alt="About Us">
			  ...
			  <div class="carousel-inner">
			   ...
			   @foreach($hotel_featured as $i=>$value)
				...
				<div class="carousel-item <?php echo $active ?>">
				     	<div class="single-room" style="background:darkgoldenrod">
			     ...
			     ?>
			                      ...
			                      <div class="col-lg-4 col-md-4">
									...
									<div class="room-desc1">
											<div class="room-cat" style="background:darkgoldenrod; padding:5px; border-radius:0px 0px 10px 10px">
											<p style="text-align:center;color:#FFF; font-size:17px font-weight:bold ">{{ $value->name }}</p>
