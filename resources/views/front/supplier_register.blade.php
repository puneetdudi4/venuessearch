...
@endif
            ...
            <div class="container ">
                <div class="contact-form-wrap section-bg">
                    <h2 class="form-title">Supplier Registration</h2>
					    ...
					    <form method="POST"  class="reg_bg" oninput='verify_password.setCustomValidity(verify_password.value != password.value ? "Passwords do not match." : "")'   action="{{ route('insert-supplier') }}" enctype="multipart/form-data">
							 ...
							 <div class="pb-13 pt-lg-0 pt-5">
							   ...
							   <div class="col-md-6 col-12">
                                <div class="input-wrap">
									...
									<input type="text" placeholder="Your Supplier Name"   required oninvalid="this.setCustomValidity('Please Enter Supplier Name')"  oninput="setCustomValidity('')"  name="company_name" value="{{ old('company_name') }}" >
			...
			@if ($errors->has('mobile_no'))
                            ...
                            <!--<div class="col-md-2 col-12" >
							  <div class="input-wrap" >							
                                            	<select name="city_code" value="{{ old('city_code') }}">
