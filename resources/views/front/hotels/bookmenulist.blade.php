<table class="table" >		
		<tr>
									 ...
									 <td width="10%"><input type="checkbox" onclick="menuremove()" > </td>
		...
		<?php
								...
								foreach ($menus	 as $menu)
								{
									...
									<tr>
									  ...
									  <td>
											<input type="radio"  name="menu_id" class="menu_id" onclick="menu_price(<?php echo $total_price ?>,<?php echo $i?>)" style="height:30px">
									  </td>
