...
<video autoplay muted loop controls src="{{asset('front_end/img/bg/hv.mp4')}}"></video>
		...
		<!-- Book Form Start -->
		<section class="booking-section" style="margin-top: -50%;">
			<div class="container-fluid">
			
				<div class="web_text" style="    width: 70%;
    margin-left: 15%;
    font-size:30px;">
	...
	<div class="row">
							...
							<div class="col-md-6 search_padding">
								<p style="    color: #000;
    line-height: 40px;
    
    padding: 30px ! important
;">
			   Book your venue and all what you require for your events with best price and offers , upon your budget and the way you like .
			   </p>
							</div>
...
من مكان واحد و بأفضل الاسعار و استفيدوا من الخصومات الرائعه و التوفير على حسب ميزانيتكم و ذوقكم
			   </p>
							</div>
			...
			<div class="web_text" style="margin-top:40px">
			...
			?>
			  ...
			  <a class="carousel-control-next fnext" href="#carouselExampleControlss" role="button" data-slide="next">
				Next >>
		       	   ...
		       	   <a class="button_image link buttonimage-fade" href="https://hotelsvenues.com/hotels" style="margin-left: 45%; font-weight: bold; color: #888181 ! important;background:#efecec9c; padding:10px  20px">View More </a>
