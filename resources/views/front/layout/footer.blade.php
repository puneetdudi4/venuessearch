 <?php
        ...
        {
           $menu_request_quote='طلب اقتباس';
		   $menu_home='الصفحة الرئيسية';
		   $menu_supplierlist='الموردون';
		   
		   $menu_hotellist='لائحة الفنادق';
		   $menu_social='مناسبات إجتماعية';
		   $menu_corporate='مناسبات عمل';
		   ...
		   $menu_customer='الزبائن';
           $menu_hotel='الفنادق / أصحاب القاعات';
           $menu_supplier='الموردون';
		   
		   $menu_privacy='سياسة الخصوصية';
		   
		   $address='العنوان';
		   $address1='سيلڤر تاور، الخليج التجاري، دبي، الامارات العربية المتحدة ';
        ...
        else
        {
		  ...
		  $menu_home='Home';
		  $menu_supplierlist='Supplier List';
		  $menu_hotellist='Hotel List';
          ...
          $menu_hotel='Hotel/Merchant';
          $menu_supplier='Supplier';
		  $menu_privacy='Privacy Policy';
		  $address='Address';
		  $address1='Silver Tower, Business Bay, Dubai, UAE';
		  $copy='Copyright ©2021. HotelsVenues All Rights Reserved.';
				...
				<div class="row">
					<div class="col-lg-4 col-md-6">
						...
						<div class="widget footer-widget">
							...
							<li><a href="{{ url('/hotels') }}">{{ $menu_hotellist }}</a></li>
							<li><a href="#">{{ $menu_supplierlist }}</a></li>
							<li><a href="#">{{ $menu_social }} </a></li>
							<li><a href="#"> {{ $menu_corporate }}</a></li>		
							<li><a href="{{ url('/privacypolicy') }}">{{ $menu_privacy }}</a></li>
					...
					<div class="col-lg-3 col-md-6">
						<div class="widget footer-widget">
							<h4 class="widget-title" style="color:#888181 ">{{ $menu_supplierlist }}</h4>
							<ul class="nav-widget clearfix">
							<?php
							...
							?>
								...
								<li><a href="/getsupplierlist/{{ $suppliermenu->menu_name }}">{{ $suppliermenu->title }} </a></li>
							<?php
					...
					<div class="col-lg-3 ">
						<div class="widget footer-widget">
							...
							<ul class="recent-post">
								...
								<!--</li>-->
								<li class="pl-0 mb-0" style="min-height: 0; color: #888181;"><i class="far fa-map-marker-alt mr-2"></i>{{ $address1 }}</li>
							...
							<li class="pl-0 mb-0" style="min-height: 0; color: #888181;"><i class="far fa-phone mr-2"></i>+971 4 435 7505</li>	
								...
								<li class="pl-0 mb-0" style="min-height: 0; color: #888181;"><i class="fab fa-whatsapp mr-2"></i>+971542046989</li>
    ...
    margin-left: 7.5%;">
			...
			<div class="footer-bottom">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<p class="copy-right text-right">{{ $copy }}</p>
					</div>
				</div>
			</div>
		</div>
