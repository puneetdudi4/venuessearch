...
/*
@media (min-width: 760px) and (max-width: 1830px) {
	.search_padding {
    padding-left: 5px ! important;
    padding-right: 5px ! important;
    width: 18% ! important;
			...
			<div class="container-fluid">
				<div class="row align-items-center">
					<div class="col-xl-3 col-lg-3 col-md-4 col-7">
						<div class="logo">
							<a href="{{ url('/') }}"><img src="{{asset('front_end/img/logo.png')}}" style="width:60%; margin-left:20%" alt="Hotels Venues"></a>
						</div>
					</div>
					<div class="col-xl-9 col-lg-9 col-md-8 col-5">
							...
							<nav class="main-menu">
								<ul class="list-inline">
								   ...
								   <li class="nav-item dropdown">
								<a class="nav-link dropdown-toggle"  href="{{ url('/aboutus') }}" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								  ABOUT US
								</a>
								<div class="dropdown-menu" aria-labelledby="navbarDropdown">
...
function aboutus()
{
	  window.location.assign("{{ url('/aboutus') }}");
