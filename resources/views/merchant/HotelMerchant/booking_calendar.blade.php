        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-body">
					...
					Start Date:
                    <br />
                    <input type="date" class="col-sm-4 form-control" name="start_date" id="start_date">
                    <br />
                    End Date:
                    <br />
                    <input type="date" class="col-sm-4 form-control" name="end_date" id="end_date">
                    <br />
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-body">
					...
					Start Date:
                    <br />
                    <input type="date" class="col-sm-4 form-control" name="start_date" id="start_dates">
                    <br />
                    End Date:
                    <br />
                    <input type="date" class="col-sm-4 form-control" name="end_date" id="end_dates">
                    <br />
                    Start time:
                    <br />
                    <input type="time" class="col-sm-4 form-control" name="start_time" id="start_times">
                    <br />
                    End time:
                    <br />
                    <input type="time" class="col-sm-4 form-control" name="finish_time" id="finish_times">
                    <br />
...
@section('pageScript')
    ...
    // ... All the calendar functionality
            ...
            $('#appointment_update').click(function(e) {
				...
				else if($('#end_dates').val() =='')
				{
					alert('Please enter End Date');
					return false ;
                }	
				else if($('#start_times').val() =='')
				{
					alert('Please enter Start Time');
					return false ;
                }	
				
				else if($('#finish_times').val() =='')
				{
                ...
                var data = {
                    ...
                    finish_time: $('#finish_times').val(),
                    venue_id: $('#venue_id').val(),
                    //date: $('#date').val(),
					start_date: $('#start_dates').val(),
					end_date: $('#end_dates').val(),
          ...
          // document.addEventListener('DOMContentLoaded', function() {
              ...
              var calendar = new FullCalendar.Calendar(calendarEl, {
					  ...
					  $.ajax({
							...
							success: function(data) {
								...
								$('#start_date').val(moment(start_date).format('YYYY-MM-DD'));
								 ...
								 $('#start_date').prop('min',moment(start_date).format('YYYY-MM-DD'));
								 
								 $('#end_date').val(moment(end_date).format('YYYY-MM-DD'));
								 
								  $('#end_date').prop('min',moment(end_date).format('YYYY-MM-DD'));
                ...
                select: function(calEvent, jsEvent, view) {
					...
					var selected_date=moment(calEvent.start).format('YYYY-MM-DD');
					
					var cdate=new Date();
					
					var current_date=moment(cdate).format('YYYY-MM-DD');
                     ...
                     var endDate = new Date(current_date);
						...
						alert('Selected date older than today date');
						return false;
					...
					$('#start_dates').val(moment(calEvent.start).format('YYYY-MM-DD'));
					
					 $('#start_dates').prop('min',moment(calEvent.start).format('YYYY-MM-DD'));
					 
					 $('#end_dates').val(moment(calEvent.start).format('YYYY-MM-DD'));
					 
					  $('#end_dates').prop('min',moment(calEvent.start).format('YYYY-MM-DD'));
