                        ...
                        <div class="card-body"> 
                            <div class="card card-custom gutter-b example example-compact" id="menu_form">
                                <div class="card card-custom gutter-b">
                                    <form action="{{url('merchant/hotel/submitFormHotelsIncludeMenu')}}" 
                                          method="post"
									  ...
									  foreach($menu_types as $menu_type)
									  {
										   ...
										   if($menu->menu_type  == $menu_type->id)
										  {
											  $slected='selected';
										  }
										  else
										  ...
										  ?>
										  <option <?php echo $slected ?> value="<?php echo $menu_type->id?>"><?php echo $menu_type->title?></option>
										  <?php
									  }
								     ...
								     <div class="bg-warning-o-100 card-header">
									  ...
									  {
										  if($menu->category_id  == $menu_cat->id)
										  {
											  $slected='selected';
										  }
										  else
										  ...
										  ?>
										  <option <?php echo $slected ?> value="<?php echo $menu_cat->id?>"><?php echo $menu_cat->title?></option>
										  <?php
									  }
                                            ...
                                            <div class="row">
                                                <div class="form-group validated col-md-4">
                                                    <input type="text" placeholder="Enter Menu Title"
                                                           class="form-control" id="menu_title" required="" name="title"
                                                           style="margin-top: 8px;" value="{{ $title ?? '' }}">
                                                </div>
                                            </div>
                                            <div class="row">
                                              
                                                <div class="form-group col-md-9" id="website_inputmenu">
                                                ...
                                                <div class="form-group validated col-md-7">
                                                    ...
                                                    <input onkeypress="return isNumberKey(event)" type="text"
                                                           ...
                                                           id="menu_cost_0" name="cost"  required=""  value="{{ $cost ?? '' }}">
                                                </div>
                                                <div class="form-group validated col-md-5">
                                                    ...
                                                    <select name="discount" class="form-control col-sm-5"
                                                        ...
                                                        <option selected style="display: none" value="" required="">Select discount %
                                                        </option>
                                                ...
                                                <div class="form-group validated col-md-3">
                                                    <label class="form-control-label" for="menu_discount">Discounted
														...
														$discount_price= $cost-$discount_price;
														?>
                                                    <input disabled type="text" class="form-control" value="<?php echo $discount_price?>"
                                                           id="menu_discount_0" name="discounted_price">
                                                </div>
                                                <div id="show_discount_0" >
                                                    ...
                                                    <div class="form-group validated">
                                                        <label class="form-control-label">Will show on your ads at home
                                                            page</label>
															<?php
															$fprice=$discount_price+10;
															?>
                                                        <input disabled type="text" class="form-control" value="<?php echo $fprice?>"
