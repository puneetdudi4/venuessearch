                    ...
                    <form class="form" action="{{ url('merchant/hotel/addHotelsMerchantData/') }}" method="post"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="address-input" required  name="address_address"
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="landline_number" required class="form-control"
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="custom-file">
                                        <!--<input type="file" class="featuredimage" name="fimage"  id="hotel_image"  onchange="validateimg(this,'hotel_image')"
                                            accept=".jpg,.jpeg,.png">-->
											
											<?php
											 if(@$hotelsData->featured_image =='')
											 {
												 $required='required';
											 }
											 else
											...
											?>
											  ...
											  <input type="file" name="featured_image"   <?php echo $required ?>   id="hotel_image"  onchange="validateimg(this,'hotel_image')"
                            ...
                            {{ $hotelsData->description ?? '' }}
                                ...
                                <div class="col-lg-6">
                                    <label>Summary :</label>
                                    <textarea name="summary" required  id="summary" class="form-control required summernote"
                                        cols="30" rows="10">
                            {{ $hotelsData->summary ?? '' }}
                        </textarea>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <div class="radio-inline">
                                            <label class="radio">
                                                <input type="radio" required @if($hotelsData && $hotelsData->is_featured == 1)
                                                checked
                                            ...
                                            <label class="radio">
                                                <input type="radio" required @if($hotelsData && $hotelsData->is_featured == 0)
                                                checked
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    ...
                                    <input id="licence"
                                        ...
                                        placeholder="Upload trade licence" type="file" name="licence" autocomplete="off"
                                        value="{{old('licence')}}" accept="application/pdf" />
                                    ...
                                    @endif
										...
										<?php
											 if(@$hotelsData->licence !='')
											 {
												 ?>
												<a href="<?php echo asset("uploads/licence/$hotelsData->licence") ?>" target="_blank"> View Licence </a>
												<?php
											 }
