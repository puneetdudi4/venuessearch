                        ...
                        <form action="{{url('merchant/hotel/submitMerchantIncludeHotel')}}" class="form" enctype="multipart/form-data"  method="POST">
                            ...
                            <div class="form-group row">
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" name="venue_name" class="form-control"
                                        placeholder="Enter Venue Name" required value="{{ old('hotel_title') }}">
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    ...
                                    <select id="city" class="form-control" name="venue_type" required required="">
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <label class="checkbox-inline">
                                                <input type="checkbox" name="event_type[]" class="event_types" value="{{$e->id}}">
                                                {{$e->title}}
                                            </label>
                                            @endforeach
                                        </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="featuredimage"  required name="fimage" id="venue_image" onchange="validateimg(this,'venue_image')"
                                            accept=".jpg,.jpeg,.png">
                             ...
                             ?>							 
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><input id="id-{{ $ci->id }}" name="capacity_id_{{ $ci->id }}"
                                                        type="checkbox" class="capacities" ></td>
                                ...
                                <div class="col-lg-6" style="margin-top: 10px;">
                                    ...
                                    <div class="mt-5">
                                        ...
                                        <label class="checkbox-inline">
                                            <input type="checkbox" name="facilities[]" class="facilities" value="{{$e->id}}">
                                            {{$e->title}}
                                        </label>
                                        @endforeach
                                ...
                                <div class="col-lg-6">
                                    <label style="font-size: 18px; font-weight: 600;">Minimum spend (in AED)
                                        :</label>
                                    <input type="number" onblur="venueprice()"   name="cost" id="cost" class="form-control" placeholder="Enter Cost"
                                        value="{{ old('cost') }}">
                                    @if ($errors->has('cost'))
                                    <span class="text-danger">
