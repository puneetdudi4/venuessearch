                            ...
                            <div class="card card-custom gutter-b">
                                <form action="{{url('merchant/hotel/submitIncludeMenuMerchant')}}" runat="server" method="post"
                                    ...
                                    <div class="bg-warning-o-100 card-header">
                                        <label class="col-sm-2" for="capacity_attribute_id">Menu Type </label>
                                        <!--<input type="text" placeholder="Enter Menu Category Title" required="" class="col-sm-6 form-check-inline form-control pl-3" id="category_title" name="category_title" autocomplete="off">
                                         -->  

                                      <select name="menu_type"  id="menu_type" class="form-control col-sm-8" required="" onchange="menucat(this.value)"	>	
									  <option value=""> Please Select </option>
									  <?php
									  foreach($menu_types as $menu_type)
									  {
										  ?>
										  <option value="<?php echo $menu_type->id?>"><?php echo $menu_type->title?></option>
										  <?php
									  }
								     ...
								     <div class="bg-warning-o-100 card-header">
                                      ...
                                      <select name="category_id"  id="category_id" class="form-control col-sm-8" required=""	>	
									  <option value=""> Please Select </option>
									  <?php
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="form-group validated col-md-8">
                                                <input type="text" placeholder="Enter Menu Title 1"  required="" class="form-control" id="menu_title" name="title[]" style="margin-top: 8px;">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <!--<div class="form-group col-md-6" id="website_inputmenu">
                                                <label for="exampleTextarea">Menu 1 Cover Image</label>
                                                <input type="file" name="image[]" required="" id="profile_image" onchange="loadPreview(this);" class="form-control" accept="image/*">
                                            </div> -->
                                            <div class="form-group col-md-8" id="website_inputmenu">
                                            ...
                                            <div class="form-group validated col-md-7">
                                                ...
                                                <input onkeypress="return isNumberKey(event)" required="" type="text" placeholder="Enter cost" class="form-control col-sm-3" id="menu_cost_0" name="cost[]">
                                            </div>
                                            <div class="form-group validated col-md-5">
...
{{--                                                <input type="text" name="discount_cost" class="form-control" value="30">--}}
                                                <select name="discount[]"  required="" class="form-control col-sm-5" onchange="calculateprice(this, 0)">
                                                    <option selected style="display: none" value="">Select discount %</option>
            ...
            $('#addSocialmenu').on('click', function() {
                ...
                if (counter < 5) {
                    ...
                    $('#social_inputmenu').append('<div  style="position: relative;" class="menu_items div_f_' + f +
                        ...
                        '    top: 10px;\n' +
                        '    right: 10px;\n' +
                        '"><i class="flaticon2-cancel-music text-danger"></i></span><div class="form-group validated col-md-8 row">' +
...
$.ajax({
    url : "{{ url('merchant/hotel/menucategory')}}",
    type: "GET",
    data : formData,
