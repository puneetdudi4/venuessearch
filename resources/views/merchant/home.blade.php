...
$(function() {
    ...
    function cb(start, end) {
		...
		$('#date_report').val(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));
...
<div class="content">
        <div class="container-fluid">
		 <form class="form" role="form" method="POST" action="{{ url('/merchant/dashboard') }}">
		 <div class="row">
			...
			<button class="btn btn-secondary font-weight-bold btn-pill"  style="margin-top:0px; padding:7px 10px">
