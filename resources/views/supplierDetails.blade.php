...
<head>
    ...
    .pagetitle {
        ...
        font-weight: 600;
        padding-bottom: 5px;
        border-bottom: 2px solid #888181 ;
    }
    ...
    <div id="carousel-thumb" class="carousel slide carousel-fade carousel-thumbnails" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
	   ...
	   $i=1;
		...
		<img src="{{ asset('uploads/hotels_featured_images/'.$images)}}"   class="d-block w-100" alt="Image">
      ...
      <ol class="carousel-indicators" style="position:relative">
	   ...
	   $i=0;
        ...
        <li data-target="#carousel-thumb" data-slide-to="<?php echo $i ?>" class="<?php echo $active?>"> 
			...
			<img src="{{ asset('uploads/hotels_featured_images/'.$images)}}"  style="height:60px"  class="d-block " alt="Image">
