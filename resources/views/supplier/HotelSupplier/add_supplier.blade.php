        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    ...
                    <!--begin::Form-->
                    <form class="form" action="{{ url('supplier/addSuppliersData/') }}" method="post"
                        ...
                        <div class="form-group row">
                            <div class="col-lg-6">
                                ...
                                <div class="input-group">
                                    ...
                                    placeholder="Enter Supplier name" value="{{ $Supplier->company_name }}" required="">
                                </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <select id="country" class="form-control" name="country" required="">
                                 ...
                                 foreach($Country as $c)
                                 {
                                    ...
                                    if($supplierData=='' && $Supplier->country == $c->id)
                                    {
                                        $selected='selected';
                                    }
                                    else if($supplierData !='' && $supplierData->country == $c->id)
                                    {
                                        $selected='selected';
                                    }
                                    else
                    ...
                    {{--                                <div class="form-group row">--}}
                        {{--                     <div class="col-lg-6">--}}
                            ...
                            {{--                        <div class="input-group">--}}
                                {{--                           <input type="text" name="location" class="form-control" required=""  placeholder="Enter Location" value="{{  $supplierData->location ?? '' }}">--}}
                            {{--                        </div>--}}
                        ...
                        <div class="col-lg-6">
                            ...
                            <select id="state" class="form-control" required=""  name="state">
                                ...
                                foreach($State as $st)
                                {
                                    ...
                                    if($supplierData=='' && $Supplier->city_code == $st->id)
                                    {
                                        $selected='selected';
                                    }
                                    else if($supplierData !='' && $supplierData->state == $st->id)
                                    {
                                        $selected='selected';
                                    }
                                    else
                                    ...
                                    <option value="{{$st->id}}" <?php echo $selected?> > <?php echo $st->name?></option>
                        ...
                        <div class="col-lg-6">
                            ...
                            <select id="city" required="" class="form-control" name="city">
                                ...
                                foreach($City as $ci)
                                {
                                    ...
                                    if($supplierData=='' && $Supplier->city == $ci->id)
                                    {
                                        $selected='selected';
                                    }
                                    else if($supplierData !='' && $supplierData->city == $ci->id)
                                    {
                                        $selected='selected';
                                    }
                                    else
                                    ...
                                    <option value="{{$ci->id}}" <?php echo $selected?> > <?php echo $ci->name?></option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" required="" id="address-input" name="address_address"
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            <div class="input-group">
                                ...
                                placeholder="Enter Phone Number" value="{{ $Supplier->landline_no }}" required="">
                            </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="input-group">
                                ...
                                placeholder="Enter Phone Number" value="{{ $Supplier->mobile_no }}" required="">
                            </div>
                            @if ($errors->has('phone_number'))
                            <span class="text-danger">
                                <strong>{{ $errors->first('phone_number') }}</strong>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            :</label>
                            <?php
                            if(@$supplierData->featured_image =='')
                            {
                                $required ='required=""';
                            }
                            else
                           ...
                           <div class="custom-file">
                            <input type="file" <?php echo $required ?>  name="fimage"
                            accept=".jpg,.jpeg,.png" >
               ...
               <tbody>
                 ...
                 <tr id="gallerytable-row">
                   <td width="55%">
                    ...
                    <input type="file" name="gallery[]"    id="gallery"   placeholder="Gallery" class="form-control single_gallery">
...
<div class="form-group row">
    <div class='list-group gallery'>
        ...
        <div class='col-sm-4 col-xs-6 col-md-3 col-lg-3' style="border:1px solid grey; margin-bottom: 10px; border-radius: 10px;">
            <a class="thumbnail fancybox" rel="ligthbox"
            href="{{ asset('uploads/hotels_featured_images/'.$image->image) }}"
            data-fancybox="images">
            <img src="{{ asset('uploads/hotels_featured_images/'.$image->image) }}"
            class="img-responsive" alt="gallery"   style="height:75px"/><br>

        </a>
        <a href="{{route('delete-more-imge', $image->id)}}" style="margin-top: -10px;">
            Delete
        </a> 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="form-group row" style="display:none">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            @if($supplierData) value="{{ $supplierData->email }}" @else value="" @endif>
                                        </div>
                                        @if ($errors->has('email'))
                                        <span class="text-danger">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-6">
                                        ...
                                        class="form-control required summernote" cols="30" rows="10" >{{ $supplierData->description ?? '' }}</textarea>
                                    ...
                                    <div class="col-lg-6">
                                        <label>Summary :</label>
                                        <textarea name="summary" required="" required  id="summary" class="form-control required summernote"
                                        cols="30" rows="10" >{{ $supplierData->summary ?? '' }}</textarea>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <div class="radio-inline">
                                                ...
                                                <label class="radio">
                                                    <input  type="radio" {{$supplierData->is_featured == 1 ? 'checked' : ''}}  value='1' name="is_featured">
                                                    <span></span>
                                                    Yes
                                                </label>
                                                <label class="radio">
                                                    <input  type="radio" {{$supplierData->is_featured == 0 ? 'checked' : ''}}  value='0' name="is_featured">
                                                    <span></span>
                                                    No
                                                </label>
                                                @else
