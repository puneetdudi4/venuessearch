                            ...
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="featuredimage" name="fimage" id="featured_image1"
                                            accept=".jpg,.jpeg,.png">
								 ...
								 <div class="col-lg-3 " style="float:left">
								  <div style="margin:30px">
								   <?php
									...
									{
										?>
										     <img src="<?php echo asset("uploads/hotels_featured_images/$gallery_image->image") ?>"
