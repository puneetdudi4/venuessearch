...
class Hotel extends Model
{
    ...
    protected $fillable=['name','sub_heading','location','country','state','city','lat','long','primary_number','capacity','featured_image','banner_img','description','summary','status','is_featured','licence','is_deleted','grade','if_is_merchant_id','if_is_admin_id','added_by'];
