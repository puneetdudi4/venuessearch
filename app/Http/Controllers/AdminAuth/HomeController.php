    ...
    */
    ...
    public function MerchantSingleView($id)
    {
        ...
        $data["hotelListData"]=DB::table('hotels')
                            ...
                            ->select('hotels.id','hotels.name','added_by','sub_heading','location','country','state','city','lat','long','primary_number','capacity','featured_image','description','summary','hotels.status','is_featured','hotels.is_deleted', 'hotels.if_is_merchant_id','grade', 'cities.name as city_name','licence')
