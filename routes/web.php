...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::get('/supplier/list', 'AdminAuth\SupplierController@index')->name('admin.supplier.list');
    Route::post('/supplier/delete/{id}', 'AdminAuth\SupplierController@destroy');
    Route::get('/supplier/view/{id}', 'AdminAuth\SupplierController@show');
    Route::get('/supplier/edit/{id}', 'AdminAuth\SupplierController@edit');
    Route::post('/supplier/update/{id}', 'AdminAuth\SupplierController@update');
    Route::get('supplierImageDelete/{id}', 'AdminAuth\SupplierController@deleteMoreImage')->name('delete-more-imge');
    ...
    Route::group(['prefix' => 'hotel'], function () {
		...
		Route::get('/hotel_status/{id}', 'AdminAuth\HotelController@hotel_status');
...
//    Route::get('/register', 'MerchantAuth\RegisterController@showRegistrationForm')->name('register');
	...
	Route::post('/dashboard', 'MerchantAuth\HomeController@merchantDashboard');
    ...
    Route::group(['prefix' => 'hotel'], function () {
        ...
        Route::get('/menucategory', 'MerchantAuth\HotelController@getmenucategory');
		...
		Route::post('submitFormHotelsIncludeMenu', 'MerchantAuth\HotelController@submitFormHotelsIncludeMenu');
	...
	//	Route::get('/addHotelsMerchantData', 'MerchantAuth\HotelController@addHotelData');
        ...
        Route::post('/submitMerchantIncludeHotel', 'MerchantAuth\HotelController@submitMerchantIncludeHotel');
		 ...
		 Route::get('/submitMerchantIncludeHotel', 'MerchantAuth\HotelController@submitMerchantIncludeHotel');
        ...
        Route::get('/bookingCalendar/', 'MerchantAuth\HotelController@bookingCalendar')->name('merchant/hotel/bookingCalendar');
		 ...
		 Route::get('/cancelationrules/', 'MerchantAuth\HotelController@cancelationrules')->name('merchant/hotel/cancelationrules');
		 
		 
		 Route::post('/savecancelrules/', 'MerchantAuth\HotelController@savecancelrules')->name('merchant/hotel/savecancelrules');
		 ...
		 Route::get('/bookinghistory/', 'MerchantAuth\HotelController@getbookinghistory')->name('merchant/hotel/getbookinghistory');
		 
		 
		 Route::get('/bookingdetails/{id}', 'MerchantAuth\HotelController@getbookingdetails')->name('merchant/hotel/getbookingdetails');
...
// added by robin 2020
Route::post('/sendenquiry', 'front\homeController@sendenquiry');

// language switch added by robin 2022

Route::get('/language', 'front\homeController@language');
...
Route::post('/closehomepopup', 'front\homeController@closehomepopup');


// Route::get('/suppiers', 'front\homeController@getSupplier');

Route::get('/hotels', 'front\homeController@getAllHotelsList');

Route::get('/aboutus', 'front\homeController@getAboutus');
Route::get('/privacypolicy', 'front\homeController@Getprivacypolicy');


Route::get('/support', 'front\homeController@getSupport');


Route::post('/quote', 'front\homeController@getquote');
...
Route::post('/bookvenues', 'front\homeController@Bookvenues');


Route::post('/savebookvenues', 'front\homeController@Savebookvenues');

Route::get('/bookingdetails/{id}', 'front\homeController@getBookingdetails');


Route::get('/getmenudetails', 'front\homeController@getmenudetails');

Route::get('/getbookmenudetails', 'front\homeController@getbookmenudetails');



Route::post('/venuesLists', 'front\homeController@getAllvenuesLists');
...
Route::get('/calendar/{id}', 'front\homeController@getCalendar');


Route::get('/eventtypes/{id}', 'front\homeController@getEventtypes');

Route::get('/eventtypes/indoor/{id}', 'front\homeController@getIndoorVenues');


Route::get('/eventtypes/outdoor/{id}', 'front\homeController@getOutdoorVenues');
...
Route::post('forgotpassword-hotel', 'User\RegisterController@forgotpasswordHotel')->name('forgotpassword-hotel');


Route::post('forgotpassword-user', 'User\RegisterController@forgotpasswordUser')->name('forgotpassword-user');


Route::post('forgotpassword-supplier', 'User\RegisterController@forgotpasswordSupplier')->name('forgotpassword-supplier');
...
Route::post('enquiry','EnquiryController@enquiry')->name('enquiry');


Route::get('user/profile', 'User\ProfileController@profile');


Route::get('user/bookinghistory', 'User\ProfileController@bookinghistory');

Route::get('user/bookinghistorydetails/{id}', 'User\ProfileController@bookinghistorydetails');
